        ...
        (u._onInitTween = function (t, e, a) {
          ...
          if (
            ...
            "string" == typeof e &&
              ...
              (b.cssText = R)),
            e.className
              ? (this._firstPT = p = l.className.parse(
                  t,
                  e.className,
                  "className",
                  this,
    ...
    var e = t(".main-navigation"),
      ...
      f = function () {
        console.info(),
          ...
          console.info(
            "👮🏿🚨👮🏿🚨 WEEWOO WEEWOO 👮🏿🚨👮🏿 IT'S THE 💾 RICCARDOZANUTTA.COM POLICE HERE 👌🏿 just tryn' to make SURE 👀 EVERYTHING IS 🛡💯💯 SAFE 😔💦💦 PLEASE ENJOY 🕋💥 OR JAVASCRIPT WILL ⚰️✈️🏙 SOCC YOU 😩🔥👌🏿💦💦"
          );
      },
      p = function () {
        o(), a(), r(), s(), n(), l();
